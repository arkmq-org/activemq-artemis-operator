...
catalog-generate: catalog-clean opm yq ## Generate the catalog by adding bundles to upstream channel. It requires BUNDLE_IMG exists before running the target"
	mkdir -p catalog
