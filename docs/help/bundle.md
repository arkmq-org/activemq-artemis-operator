...
## Deploy a single ArkMQ Broker

The following command line deployes a single ArkMQ Broker instance by applying the ActiveMQArtemis custom resource (CR) defined in artemis_single.yaml file:
