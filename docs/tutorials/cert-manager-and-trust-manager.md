...
There are various scenarios how SSL can be achieved for your ArkMQ Broker brokers, to list some:
...
In this tutorial we will cover the first scenario "ArkMQ Broker brokers handling SSL termination" with no assumption it is the best for your cluster, please consider the best setup yourself.
...
### Create certificate for ArkMQ Broker brokers
...
### Create a secret with the details of your ssl setup for the ArkMQ Broker broker
